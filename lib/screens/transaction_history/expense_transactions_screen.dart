...
class ExpenseTransactionsScreen extends StatefulWidget {
  ...
  const ExpenseTransactionsScreen({Key? key, required this.selectedDate})
      : super(key: key);

  @override
  State<ExpenseTransactionsScreen> createState() =>
      _ExpenseTransactionsScreenState();
}

class _ExpenseTransactionsScreenState extends State<ExpenseTransactionsScreen> {
  @override
  Widget build(BuildContext context) {
    TransactionsProvider transProvider =
        Provider.of<TransactionsProvider>(context);
    List<Map<String, dynamic>> dailyTranList =
        transProvider.expenseTransactionsForOneMonth();
                          ...
                          itemBuilder: (context, index2) {
                            return Dismissible(
                              ...
                              onDismissed: (direction) async {
                                await transProvider.deleteExpense(
